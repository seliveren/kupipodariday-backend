...
export const wishDeletionNotAllowed = 'Нельзя удалять чужие подарки!';
export const wishlistsNotFound = 'Вишлистов нет!';
export const wishlistNotFound = 'Такого вишлиста не существует!';
export const wishlistEditNotAllowed = 'Нельзя редактировать чужие вишлисты!';
export const wishlistDeletionNotAllowed = 'Нельзя удалять чужие вишлисты!';
